...
class ShowingSubject extends StatefulWidget {
  ...
  const ShowingSubject(
      {super.key, required this.onBack, required this.onNavigate, required this.onNavigateDraft});
...
late ToggleModelClass toggle;
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                addSubjectpage == false && draftpage == false
                  ...
                  if (state is PublishedBlocLoaded) {
                    subject =
                        BlocProvider
                            .of<PublishedSubjectBloc>(context)
                            .publishedsubject;
    ...
    if (state is ToggleBlocLoaded) {
      ...
      toggle=BlocProvider.of< ToggleSujectBloc>(context).togglesubject;


    } },
                                              child: InkWell(
                                                onTap: () {
                                                  BlocProvider.of< ToggleSujectBloc>(context).add(FeatchToggle(SubjectId: subject
                                                      .published![position]
                                                      .objectId
                                                      .toString()));
